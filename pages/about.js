  ...
  return (
    <>
      <div className="relative w-full min-h-[calc(100vh-80px)]">
        <Image
          src={"/image/banner-4.avif"}
          alt="casami-banner"
          fill
          className="w-full h-full object-cover object-left-top -z-10 brightness-75"
        />
        <div className={`absolute inset-0 flex justify-center items-center`}>
          <div className="w-full sm:w-[500px] flex justify-center items-center flex-col lg:gap-9 gap-4">
            <h3 className="text-heading text-white">CASAMI</h3>
            <p className="text-white text-center leading-6">
              Our company was founded by a group of Marketing specialists with
              over 20 years of experience and a team of highly qualified
              individuals.
            </p>
          </div>
        </div>
      ...
      <div className="container max-w-[630px] flex-center flex-col gap-8 text-center">
        <h3 className="text-heading text-5xl">
          MORE THAN 5 YEARS OF ESTABLISHMENT
        </h3>
        <div>
          <svg
            height="100"
        ...
        <p>
          Our company&apos;s management team consists of marketing specialists
          with over 20 years of expertise. They have advised and conducted
          numerous large-scale marketing campaigns for well-known brands in
          Cambodia and the regions.
        </p>
        <p>
          We have more than 100 highly qualified employees. They used to work
          for a variety of big corporations both in Cambodia and abroad. They
          all have creativity, enthusiasm, and dedication.
        </p>
      </div>
      <div className="relative w-full min-h-[calc(100vh-80px)]">
        <div className="absolute inset-0">
          <Image
            src={"/image/banner-5.avif"}
            alt="casami-banner"
            fill
        ...
        <div className={`absolute inset-0 flex justify-center items-center`}>
          <div className="w-full sm:w-[650px] flex justify-center items-center flex-col lg:gap-9 gap-4">
            <h3 className="text-heading text-white">OUR COMMITMENTS</h3>
            <p className="text-white text-center leading-6">
